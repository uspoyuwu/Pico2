...
#define ALARM_IRQ \
    timer_hardware_alarm_get_irq_num(timer_hw, ALARM_NUM)
...
unsigned int scancodes[KEYROWS] =
{
    0xE,
    0xD,
    0xB,
...
static PT_THREAD(protothread_adc(struct pt *pt))
{
    ...
    while (1)
    {
        ...
        // Debug output
        printf(
            "ADC: %u, Frequency: %.2f Hz, Amp: %.2f, Mode: %d\n",
            adc_val,
            current_frequency,
            amplitude,
            system_mode
            ...
            case MAYBE_NOT_PRESSED:
                ...
                else
                {
                    ...
                    )
                    {
                        ...
                        printf(
                            "Finished recording key %d, samples = %d\n",
                            recording_key,
                            record_index
                        );
